...
mapbio_2020_reclass_pasture <- classify(mapbio_2020_cropped, reclass_m_mosaic)
...
```{r}
# add chen and mapbiomas rasters 
chen_mapbio_crop_2020_pasture <- mapbio_crop_2020_pasture + chen_crop_2020_brazil

# return frequency of each value (0, 1, 10, 11) in new raster
counts2020p <- freq(chen_mapbio_crop_2020_pasture)
counts2020p

# break up freq values ba
nocrop_2020p <- counts2020p[1, 3]
crop_mapbio_only_2020p <- counts2020p[2, 3]
crop_chen_only_2020p <- counts2020p[3,3]
crop_both_2020p <- counts2020p[4,3]

## break down into values for confusion matrix

# number of real positive cases (P), pixels for which mapbiomas observed cropland
p <- crop_mapbio_only_2020p + crop_both_2020p
# number of real negative cases (N), pixels for which mapbiomas did not observe cropland
n <- nocrop_2020p + crop_chen_only_2020p

# true positive
tp <- crop_both_2020p
# false positive
fp <- crop_chen_only_2020p
# true negative
tn <- nocrop_2020p
# false negative
fn <- crop_mapbio_only_2020p
...
cm_2020_pasture <- matrix(c(tp, fn, fp, tn), ncol=2, byrow=TRUE)
colnames(cm_2020_pasture) <- c("Predicted Positive", "Predicted Negative")
rownames(cm_2020_pasture) <- c("Observed Positive", "Observed Negative")
cm_2020_pasture

cm_2020_pasture_perc <- matrix(c(tpr, fnr, fpr, tnr), ncol=2, byrow=TRUE)
colnames(cm_2020_pasture_perc) <- c("Predicted Positive", "Predicted Negative")
rownames(cm_2020_pasture_perc) <- c("Observed Positive", "Observed Negative")
cm_2020_pasture_perc
